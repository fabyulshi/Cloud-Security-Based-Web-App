	...
	<div id="page" style="margin-top:25px;">
		<div id="content">
		   ...
		   try
		   {
				...
				{
				%>
				<form name="fm" action="nex.jsp">
					 <td align="center">Your Key is :<%=key1%></td>		
					  <td align="center">Enter Your Key Here :<input type="text" name="kk">&nbsp;&nbsp;<input type="submit" value="SUBMIT"></td>	
