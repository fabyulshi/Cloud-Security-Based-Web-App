	...
	<div id="page" style="margin-top:25px;">
     ...
     <br /><BR />
				...
				<img src="images/animated_arrow_11.gif" width="57" height="35" align="left" />         
                   <h3 class="title"><a href="file_update.jsp" style="font-size:24px;color:#6600FF;text-transform:none;"><b>Request To View The File</b></a></h3>
                   <img src="images/fff.png" width="78" height="78" style="float:right; margin-top:-50px;margin-right:80px;"/>
