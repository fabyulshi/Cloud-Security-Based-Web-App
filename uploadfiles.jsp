	...
	<div id="page" style="margin-top:25px;">
		<div id="content">
               ...
               <div style="width:100%;margin-top:80px;">
                   ...
                   <span style="font-size:24px;color:#F03;font-weight:bold;margin-left:120px;" >Insert New File</span>
    
     <br /><BR />
     
        
           <form enctype="multipart/form-data" method="post" class="well form-search" name="form" action="insertfile.jsp" onsubmit="return login();" >
            <input id="uploadFile"  class="span3" placeholder="Choose File" disabled="disabled" style="width:250px;" />
               
                    <input id="uploadBtn" type="file" name="image" class="upload" />
                         <br />
               <br />
                <button class="btn btn-success" type="submit" style="width:100px">Insert</button>
                 <button class="btn btn-danger" type="reset"  style="width:100px">Reset</button>
