...
<h1 style="padding:10px;padding-top:15px;padding-left:40px;line-height:40px;color:#FFFFFF;">A Hybrid Cloud Approach for Secure Authorized
	...
	<div id="banner">
              ...
              <ul class="nav nav-pills" style="float:right;margin-top:-25px;">
                 ...
                 <li><a href="userhome.jsp" style="font-size:18px;margin-left:10px;margin-right:10px;">Home</a></li>
                 <li class="active"><a href="download.jsp" style="font-size:18px;margin-left:10px;margin-right:10px;" >Upload File</a></li>
	...
	<div id="page" style="margin-top:25px;">
		<div id="content">
				...
				<h3 class="title"><u>Welcome to User</u></h3>
				...
				<div style="clear: both;">&nbsp;</div>
                 ...
                 <div style="width:100%;margin-top:100px;">
                   ...
                   <h3 class="title"><a href="uploadfiles.jsp" style="font-size:24px;color:#6600FF;text-transform:none;"><b>To Upload Files</b></a></h3>
		...
		<div id="sidebar" style="width:300px;">
			<img src="images/fff.png" width="300" height="368" style="margin-top:5px;"  />
		</div>
		<!-- end #sidebar -->
		<div style="clear: both;">&nbsp;</div>
	</div>
